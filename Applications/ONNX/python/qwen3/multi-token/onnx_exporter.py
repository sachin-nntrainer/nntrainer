...
for step in range(num_tokens_to_generate):  # generate 20 tokens
    ...
    outputs = official_model(input_ids=generated)
...
position_ids = (
    torch.arange(generated.shape[1]).reshape(1, -1).repeat(generated.shape[0], 1)
)
...
for step in range(num_tokens_to_generate):  # generate 20 tokens
    ...
    outputs = custom_model(generated.reshape(max_len, 1), cos, sin, variance_epsilon)
...
torch.onnx.export(
    custom_model,
    (generated.reshape(max_len, 1), cos, sin, variance_epsilon),
    "./qwen3_model.onnx",
    export_params=True,
    opset_version=17,
