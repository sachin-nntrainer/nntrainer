...
class Qwen3Attention(nn.Module):
    ...
    def forward(
        ...
        #The above line is replaced by mul and reduce sum (below). 
        # This one works in the case of single token inference only. 
        # This is done to overcome matmul layer issue in nntrainer when computing attention.    
        ...
        # The line above replaces the below two
...
class Qwen3Model(PreTrainedModel):
    ...
    def forward(
        ...
        # broadcasting (1,1) to (1,1,1,self.config.hidden_size)
