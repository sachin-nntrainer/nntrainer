 ...
 *
 * @file   kai_lhs_quant_pack_qsi8d32p_f32_neon.c
 * @date   8 December 2025
 * @see    https://github.com/ARM-software/kleidiai
 * @see    https://github.com/nntrainer/nntrainer
 * @author Sungsik Kong <ss.kong@samsung.com>
 *
 * @brief  LHS Quantized Packing for QSI8D32P (NEON)
 *
...
size_t kai_get_m_step_lhs_quant_pack_qsi8d32p_f32_neon(size_t mr) { return mr; }
...
void kai_run_lhs_quant_pack_qsi8d32p_f32_neon(
  ...
  for (size_t m_idx = 0; m_idx < m; m_idx++) {
    ...
    uint16_t *lhs_packed_scales =
      (uint16_t *)(lhs_packed_ptr + lhs_packed_stride -
                   ((mr * num_blocks) * kai_num_bytes_multiplier));
