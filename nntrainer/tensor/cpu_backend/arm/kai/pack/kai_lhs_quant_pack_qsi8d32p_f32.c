...
size_t kai_get_m_step_lhs_quant_pack_qsi8d32p_f32(size_t mr) { return mr; }

size_t kai_get_lhs_offset_lhs_quant_pack_qsi8d32p_f32(size_t m_idx,
                                                      size_t lhs_stride) {
...
size_t kai_get_lhs_packed_size_lhs_quant_pack_qsi8d32p_f32(size_t m, size_t k,
                                                           size_t bl, size_t mr,
                                                           size_t kr,
                                                           size_t sr) {
  KAI_ASSUME((k % 2) == 0);
...
void kai_run_lhs_quant_pack_qsi8d32p_f32(size_t m, size_t k, size_t bl,
  ...
  for (size_t row_idx = 0; row_idx < num_rows; ++row_idx) {
    const float *src_ptr =
      (const float *)((const uint8_t *)lhs +
                      (row_idx + m_idx_start) * lhs_stride);
    ...
    for (size_t b = 0; b < num_blocks_per_row; ++b) {
      ...
      *((uint16_t *)(dst_ptr + dst_x * kai_num_bytes_multiplier)) =
        kai_cast_f16_f32(scale);
